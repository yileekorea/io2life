			...
			<div class="col-md-12">
			  ...
			  <div class="box box-primary">
				...
				<div class="box-header with-border">
					<h2 class="box-title"><b>방-1 : <?php echo $tbl_TempSet[$room_x][roomName];; ?>의 온도 그래프</h2></b>
                            <div class="header">
				  ...
				  <div class="row">
					<div class="col-md-12">
						...
						<div class="content">
							...
							<!--<div id="<?php echo $roomParamG?>" style="min-width: 310px; height: 400px; margin: 0 auto"></div>-->
						</div>
					</div>
					<!-- /.col -->
				  </div>
...
<!--<script src="./assets/js/demo_master_detail.js"></script>-->
