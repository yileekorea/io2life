...
<div class="header">
	<h4 class="title">Temperature Behavior</h4>
	        <input type='text' id='test_datepicker' />

</div>

				<div class="box-header with-border">
					<h3 class="box-title">일일 온도 변화 추이</h3>
...
<input type="text" class="form-control pull-right" id="test_datepicker" data-date-format="yyyy-mm-dd">
							</div>
						  </div>
-->
