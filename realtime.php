                            ...
                            <div class="header">
								...
								<div class="col-xs-12">
									<div class="input-group">
										<input type="text" class="form-control date-input" id="date-fld" placeholder="오늘 <?php echo date("Y-m-d");?>" disabled />
				...
				<div class="box-body">
				  <div class="row">
					<div class="col-md-12">
						<!-- /.chart-responsive -->
						<div class="content">
							<div id="container_real" style="min-width: 310px; height: 400px; margin: 0 auto"></div>
						</div>
					</div>
					<!-- /.col -->
				  </div>
...
<script src="./assets/js/demo_realtime.js"></script>
